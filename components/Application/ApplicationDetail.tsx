        ...
        {selectedApplication ? (
          <>
            ...
            <div className="sticky top-0 flex-col items-center justify-between px-5 pb-10 h-[calc(100vh_-_200px)] overflow-auto bg-white border-b">
                {selectedApplication.candidate.hashed_resume_name && <embed src={`http://localhost:3000/api/viewResume?id=` + selectedApplication.candidate.hashed_resume_name} className='w-full min-w-[400px] h-[50vh]' />}
