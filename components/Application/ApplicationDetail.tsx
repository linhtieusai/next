          ...
          <>
            ...
            <div className="sticky top-0 flex-col items-center justify-between px-5 pb-10 h-[calc(100vh_-_200px)] overflow-auto bg-white border-b">
                <div className="flex-row">
                    <h3 className="mt-3 text-sm font-bold mb-4">Time Line</h3>
                    <div className="timeline text-sm">
                        <ol className="relative border-l border-gray-200 dark:border-gray-700">
                          {selectedApplication.application_logs && selectedApplication.application_logs.map((applicationLog) => (
                              <>
                                <li className="mb-10 ml-6">            
                                  ...
                                  <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">{applicationLog.status} <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Latest</span></h3>
                          ...
                          <li className="ml-6">
                              ...
                              <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Application submitted</h3>
                              <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{selectedApplication.created_at}</time>
