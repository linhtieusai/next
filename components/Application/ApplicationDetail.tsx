        ...
        {selectedApplication ? (
          <>
            ...
            <div className="sticky top-0 flex-col items-center justify-between px-5 pb-10 h-[calc(100vh_-_200px)] overflow-auto bg-white border-b">
                <div className="flex-row max:sm:flex-row-reverse  md:flex">
                          ...
                          {selectedApplication.application_logs && selectedApplication.application_logs && (
                              <li className="mb-10 ml-6">            
                                    ...
                                    <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
                                      {ApplicationStatus.STATUS[selectedApplication.application_logs[selectedApplication.application_logs.length -1 ].status]} 
