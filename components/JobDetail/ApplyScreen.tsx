                        ...
                        <label className=" mb-5 flex flex-col items-center justify-center w-full px-5 border-2 border-gray-300 border-dashed rounded-lg 
                          ...
                          <div className="flex items-center justify-center py-2 space-x-2">
                              ...
                              <div>
                                ...
                                {presubmitInfo.draftApplication.candidate.name && (
                                  <p className="text-sm font-bold text-gray-500 dark:text-gray-400">{presubmitInfo.draftApplication.candidate.name}</p>
                                )}
                              </div>
                          </div>
                      </label>
