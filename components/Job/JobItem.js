...
export default function JobItem({ job, handleOnClick, isSelected }) {  
    return (
        <div  key={job.id} onClick={() => handleOnClick(job)}
            className={`mt-4 rounded-lg p-4 cursor-pointer hover:shadow-lg hover:border-green-300  hover:border-opacity-50 hover:rounded-lg focus:border-green-500  focus:outline-none focus:shadow-lg focus:border-opacity-50 focus:rounded-lg active:border-gray-400 active:border-opacity-75 active:rounded ${
            ...
            >
              <div className="flex justify-between md:flex-col lg:flex lg:items-center">
