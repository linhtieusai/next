      ...
      <div className="p-4 lg:w-2/3">
        {selectedJob ? (
          <>
            ...
            <div className="sticky top-0 flex-col items-center justify-between px-5 py-10 h-[calc(100vh_-_100px)] overflow-auto bg-white border-b">
                <div className="flex justify-between">
                  <h1 className="flex-none max-w-full ml-2 text-2xl font-bold overflow-ellipsis clamp-2">{selectedJob.title}</h1>
