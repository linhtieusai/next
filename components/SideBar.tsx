      ...
      <div className="flex flex-col">
          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <li className="rounded-sm">
              <Link
                href="/"
                className={`flex items-center p-2 space-x-3 rounded-md ${isActive('/')}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-black-100">Home</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
                href="viewed"
                className={`flex items-center p-2 space-x-3 rounded-md  ${isActive('/viewed')}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6 text-black-100"
                ...
                <span className="text-black-100">Job đã xem</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
            ...
            {/* <li className="rounded-sm">
              ...
              >
                ...
                <span className="text-black-100">Settings</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
