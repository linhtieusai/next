class ApplicationStatus {
    ...
    static STATUS_REQUIRED_INFO_SUBMITTED = 41;
    ...
    static STATUS = {
      ...
      [ApplicationStatus.STATUS_SITE_REJECTED]: 'ViecThom đã từ chối',
      [ApplicationStatus.STATUS_INFO_REQUIRED]: 'Yêu cầu bổ sung thông tin',
      [ApplicationStatus.STATUS_REQUIRED_INFO_SUBMITTED]: 'Thông tin đã được bổ sung',
    ...
    static STATUS_NEXT = {
      ...
      [ApplicationStatus.STATUS_SITE_REJECTED]: '',
      [ApplicationStatus.STATUS_INFO_REQUIRED]: 'Chờ bổ sung thông tin ứng viên',
      [ApplicationStatus.STATUS_REQUIRED_INFO_SUBMITTED]: 'Chờ ViecThom xác nhận',
    ...
    static STATUS_ICON = {
      ...
      [ApplicationStatus.STATUS_SITE_REJECTED]: 'n',
      [ApplicationStatus.STATUS_INFO_REQUIRED]: 'n',
      [ApplicationStatus.STATUS_REQUIRED_INFO_SUBMITTED]: 'y',
    ...
    static STATUS_COLOR = {
      [ApplicationStatus.STATUS_SUBMITTED]: 'green',
      [ApplicationStatus.STATUS_SITE_VIEWED]: 'green',
      [ApplicationStatus.STATUS_SITE_REJECTED]: 'red',
      [ApplicationStatus.STATUS_INFO_REQUIRED]: 'yellow',
      [ApplicationStatus.STATUS_REQUIRED_INFO_SUBMITTED]: 'green',
      [ApplicationStatus.STATUS_CLIENT_VIEWED]: 'green',
      [ApplicationStatus.STATUS_CLIENT_REJECTED]: 'red',
      [ApplicationStatus.STATUS_INTERVIEW_INVITED]: 'green',
      [ApplicationStatus.STATUS_INTERVIEW_CANCELED]: 'red',
      [ApplicationStatus.STATUS_INTERVIEW_RESULT_FAILED]: 'red',
      [ApplicationStatus.STATUS_OFFER_SENT]: 'green',
      [ApplicationStatus.STATUS_OFFER_ACCEPTED]: 'green',
      [ApplicationStatus.STATUS_OFFER_DECLINED]: 'red',
      [ApplicationStatus.STATUS_NEGOTIATION_REQUIRED]: 'yellow',
      [ApplicationStatus.STATUS_CANDIDATE_FILLED]: 'green',
      [ApplicationStatus.STATUS_CANDIDATE_PROBATION_PASSED]: 'green',
      [ApplicationStatus.STATUS_CANDIDATE_STARTED_FIRST_DAY]: 'green',
    };
  }
